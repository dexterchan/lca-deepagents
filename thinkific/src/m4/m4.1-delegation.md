...
If you've seen *The Devil Wears Prada*, this is basically it: Miranda Priestly doesn't want to hear how Andy got something done, just the result. That's the subagent's job here, too. It does the messy work, then hands the main agent only what it actually needs to know, not the boring details.
